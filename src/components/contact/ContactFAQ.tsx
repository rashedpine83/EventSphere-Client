      ...
      <div className="container mx-auto max-w-5xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-400">
            ...
            need assistance, do not hesitate to contact our support team.
          </p>
        </motion.div>
        ...
        >
          {faqs.map((faq) => (
            <AccordionItem key={faq.key} aria-label={faq.title}>
              <div className="font-semibold text-white text-lg">
                {faq.title}
              </div>

              <p className="text-slate-400 leading-8 mt-3">{faq.content}</p>
            </AccordionItem>
          ))}
        </motion.div>
      </div>
